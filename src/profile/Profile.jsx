            ...
            <div className="flex-1 overflow-y-auto p-4 no-scrollbar">
              {activeTab === "overview" && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 space-y-4">
                  <StatsGrid profileUser={profileUser || {}} isOwnProfile={isOwnProfile} loading={loading} />
                  <CodingStats profileUser={profileUser || {}} loading={loading} />
                  <Milestones profileUser={profileUser || {}} loading={loading} />
                </div>
              )}
