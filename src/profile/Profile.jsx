          ...
          <div className="relative z-10 w-full flex flex-col items-center h-full">
            ...
            <div className="mb-6">
              <h1 className="text-xl font-bold text-white mb-1 flex items-center justify-center gap-2">
                ...
                <Shield
                  size={16}
                  className="text-[#FFD700] fill-[#FFD700]/20"
                />
              </h1>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-white/5 w-full flex justify-center shrink-0">
              <div className="text-xs text-gray-600 flex items-center gap-2 font-medium">
                ...
                Joined{" "}
                {new Date(
                  profileUser.date_joined || Date.now(),
                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {[
                      ...
                      >
                        <div
                          className={`p-2 w-fit rounded-lg bg-white/5 ${stat.color}`}
                        >
                          <stat.icon size={16} />
                        </div>
                        <div>
                        ...
                        return completedLevels.map((level) => (
                          ...
                          >
                            <div className="w-8 h-8 rounded-lg bg-black/50 flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform text-white/50 group-hover:text-[#FFD700]">
                              {level.icon &&
                                React.cloneElement(level.icon, { size: 14 })}
                            </div>
            ...
            {listLoading ? (
              ...
              <div className="space-y-1">
                {userList.map((user) => (
                  <div
                    key={user.username}
                    className="flex items-center justify-between p-3 hover:bg-white/5 rounded-2xl transition-colors group"
                  >
                    <Link
                    ...
                    {currentUser && currentUser.username !== user.username && (
                      <Link
                        to={`/profile/${user.username}`}
                        onClick={() => setListType(null)}
                        className="px-3 py-1.5 bg-white/5 hover:bg-white/10 rounded-lg text-xs font-bold text-[#FFD700] transition-colors"
                      >
                        View
                      </Link>
                    )}
        ...
        <DialogContent className="bg-[#121212] border border-white/10 text-white sm:max-w-md rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400 pt-2">
              ...
              be undone and you will lose all your progress and data.
            </DialogDescription>
          </DialogHeader>
