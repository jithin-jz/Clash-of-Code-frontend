...
const RightSideUI = ({
  ...
  const glassButtonClass =
    "h-14 w-14 p-0 bg-[#121212]/80 backdrop-blur-xl border border-white/10 rounded-2xl hover:border-[#FFD700]/50 hover:bg-[#1a1a1a] transition-all text-white shadow-lg active:scale-95";
  ...
  return (
    <div className="fixed right-6 top-6 z-30 flex flex-col gap-4 items-end animate-slide-in-right">
      ...
      <div className="relative">
        ...
        {settingsOpen && (
          <div className="absolute right-full top-0 mr-2 w-40 rounded-2xl overflow-hidden z-40 bg-[#121212] border border-white/10 shadow-2xl backdrop-blur-3xl animate-in fade-in zoom-in-95 slide-in-from-right-2 duration-200">
            <div className="p-1">
              {/* Menu Items */}
