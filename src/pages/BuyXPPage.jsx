      ...
      <div className="relative z-10 max-w-7xl mx-auto pt-16">
        ...
        <div className="max-w-6xl mx-auto mb-16 flex items-center justify-between">
            <div className="flex items-center gap-6">
                ...
                >
                    <ArrowLeft className="group-hover:-translate-x-1 transition-transform text-gray-400 group-hover:text-white" size={20} />
                </Link>
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-white mb-1">
                        XP Store
                    </h1>
                    <p className="text-gray-500 text-sm font-medium">Accelerate your progress</p>
                </div>
            </div>
        </div>
                ...
                <div className="mb-8">
                    <div className="flex justify-between items-start mb-4">
                        <div className="p-3 bg-white/5 rounded-lg text-white group-hover:text-[#FFD700] transition-colors">
                            <Zap size={20} fill="currentColor" className="opacity-70 group-hover:opacity-100 transition-opacity" />
                        </div>
                        {idx === 3 && (
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2">{pkg.label}</h3>
                    <div className="flex items-baseline gap-1">
                        <span className="text-3xl font-bold tracking-tighter text-white">{pkg.xp.toLocaleString()}</span>
