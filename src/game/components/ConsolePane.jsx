...
const ConsolePane = ({ output, loading }) => {
  if (loading) {
    return (
      <div className="flex-1 flex flex-col bg-[#1a1a1a] border-t border-white/5 animate-pulse">
        <div className="px-4 py-2 border-b border-white/5 bg-[#262626]">
  ...
  return (
    <section className="flex-1 flex flex-col bg-[#1a1a1a] m-0 h-full">
      <div className="flex-1 p-0 overflow-y-auto custom-scrollbar font-mono text-sm relative bg-[#1a1a1a]">
        {output.length === 0 && (
