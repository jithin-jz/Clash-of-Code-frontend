...
const AppContent = () => {
    ...
    // Theme and Font application logic removed to restrict customization to the IDE (CodeArena) only.
    // The global UI will remain consistent with the default app theme.
